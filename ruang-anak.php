...
<body>
                    ...
                    <div class="col-lg-6 col-12 mb-4 mb-lg-0">
                        <div class="custom-block text-center">
                            <div class="custom-block-info custom-block-overlay-info">
                                <a href="laporan.php?huruf=B" target="_blank" type="button" class="btn btn-md btn-primary"><i class="fa-solid fa-file"></i> Laporan</a>
    ...
    <script language="javascript">
        ...
        function confirmExit() {
            return "Pastikan sebelum di close, semua antrian sudah dipanggil atau selesai!";
        }
    </script>
