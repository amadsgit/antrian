...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="images/pkm.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">SI Antrian Cikalapa</span>
    </a>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header bg-info">
                <h3 class="card-title">Rekapitulasi antrian Ruang Umum</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                    $sql = "SELECT tanggal, waktu, nama, huruf, nomor, loket, ke_loket, ruang, panggil, farmasi FROM tabelrekap ORDER BY id DESC";
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php 
                          ...
                          if($farmasi =='menunggu') {
                            echo"<span class='badge bg-warning'>$farmasi</span>";
                          } else {
                            echo"<span class='badge bg-success'>$farmasi</span>";
                          }
                        ?></td>
                      </tr>
                  <?php $no++;  } ?>
