<?php
    ...
    $_SESSION['page']='ruang-laboratorium.php';
    // error_reporting(0);
?>
<!doctype html>
<html lang="en">
                    ...
                    <div class="col-lg-6 col-12 mb-4 mb-lg-0">
                        <div class="custom-block text-center">
                            <div class="custom-block-info custom-block-overlay-info">
                                <a href="laporan.php?huruf=L" target="_blank" type="button" class="btn btn-md btn-primary"><i class="fa-solid fa-file"></i> Laporan</a>
